...
- Deriving lower bounds under various possible $\theta$ values to satisfy
  ...
  - $\beta_K(\theta_0)=\beta(\theta_0)$ where $\beta(\theta_0)$ is the probability of crossing a lower bound under the null hypothesis $H_0: \theta=\theta_0$ 
  - $\beta_K(\theta)=\beta(\theta^*)$ where $\beta(\theta^*)$ is the probability of crossing a lower bound under some arbitrary $H: \theta = \theta^*$
