...
testthat::test_that("expect equal with mvtnorm for efficacy and futility bounds",{
...
testthat::test_that("expect equal with gsDesign::gsProbability outcome for efficacy bounds",{
