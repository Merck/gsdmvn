...
-   **Sample-Size Weights (SS):** $$
    ...
    $$ where $N_{C,s,k}, N_{E,s,k}$ are the planned sample size of the
    $s$-th strata and $k$-th analysis of the control group and
    experimental group, respectively. And
    $\widehat N_{C,s,k}, \widehat N_{E,s,k}$ are the observed sample
