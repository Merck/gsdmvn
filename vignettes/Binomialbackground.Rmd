...
save(ans, file = "./fixture/rd_simu_power_gspowernpe_3_weight_new.Rdata")
```


```{r}
load("./fixture/rd_simu_power_gspowernpe_3_weight_new.Rdata")
ans %>% 
...
```{r}
load("./fixture/rd_simu_power_pmvtnorm_3_weight.Rdata")
ans %>% 
  group_by(`calculated under`) %>% 
  summarize(`simulated power - ss` = mean(ss), 
         `simulated power - invar H0` = mean(invar_H0), 
