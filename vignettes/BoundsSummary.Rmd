...
The function used to generate bounds tables is `gsdmvn::summary()`. 
...
lpar <- list(par = list(sf = gsDesign::sfHSD, total_spend = 0.1, param = 0, timing = NULL))
