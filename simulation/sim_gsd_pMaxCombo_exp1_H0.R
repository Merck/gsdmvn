...
results <- list(
  s01  = sim_gsd_pMaxCombo_exp1_H0(N = ceiling( 454.60))
)
...
# cd /SFS/scratch/shirazam/sim_gsd_pMaxCombo_exp1_H0
# rm *
# cp ~/pkg/gsdmvn/simulation/*.R .
# module add R/4.0.2
# qsub -t 1:2000 ~/runr.sh ~/pkg/gsdmvn/simulation/sim_gsd_pMaxCombo_exp1_H0.R

#-------------------------------
# Summarize simulation results
#-------------------------------

# path <- "/SFS/scratch/shirazam/sim_gsd_pMaxCombo_exp1_H0"
#
# res <- list()
# for(i in 1:10000){
...
# save(sim_gsd_pMaxCombo_exp1_H0, file = "./simulation/sim_gsd_pMaxCombo_exp1_H0.Rdata")
