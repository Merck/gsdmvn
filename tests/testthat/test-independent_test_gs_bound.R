...
test1 <- gsdmvn:::gs_bound(alpha = sfLDOF(0.025, 1:3/3)$spend,
...
testthat::test_that("compare with results from gsDesign, 3 analyses, unequal IA timing", {
  ...
  y <- gsDesign::gsSurv( k = 3, test.type = 4 , alpha = 0.025,
  ...
  test2<- gsdmvn:::gs_bound(alpha = sfLDOF(0.025, 3:5/5)$spend,
                            beta = sfLDOF(0.2, 3:5/5)$spend,
                            analysis = 1:3,
